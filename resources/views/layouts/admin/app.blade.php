...
<body class="theme-red">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../../index.html">BACKEND TEKNIK KOMPUTER</a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            <!-- User Info -->
            <div class="user-info" style="background: url( {{ asset('assets/admin/images/user-img-background.jpg') }} ) no-repeat no-repeat;">
                <div class="image">
                ...
                <div class="info-container" >
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <li><a href="#"><i class="material-icons">lock</i>Cange Password</a></li>

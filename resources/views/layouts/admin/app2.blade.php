      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{asset('assets/adminlte/index.html') }}"><i class="fa fa-file-text"></i> MY POST</a></li>
            <li><a href="{{asset('assets/adminlte/index2.html') }}"><i class="fa fa-pencil"></i> ADD POST</a></li>
          </ul>
        </li>

        <li class="treeview">
          <a href="#">
            <i class="fa fa-list-alt"></i> <span>POST MANAGEMENT</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{asset('assets/adminlte/index.html') }}"><i class="fa fa-file-text"></i> DATA POST</a></li>
            <li><a href="{{asset('assets/adminlte/index2.html') }}"><i class="fa fa-pencil"></i> DATA CATEGORY</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('admin.profile.index') }}"><i class="fa fa-user"></i> MY PROFILE</a></li>
            <li><a href="{{ route('admin.profile.edit.password') }}"><i class="fa fa-unlock-alt"></i> CANGE PASSWORD</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-gear"></i> SITE INFO</a></li>
            <li>
              ...
              <ul class="treeview-menu">
                <li><a href="{{ route('admin.users.index')}}"><i class="fa fa-user"></i> DATA USER</a></li>
